            ...
            for i, x_sample in enumerate(x_samples_ddim):
                ...
                if use_GFPGAN and st.session_state["GFPGAN"] is not None and not use_RealESRGAN:
                    ...
                    save_sample(gfpgan_image, sample_path_i, gfpgan_filename, jpg_sample, prompts, seeds, width, height, steps, cfg_scale,
                                                    ...
                                                    n_iter, batch_size, i, denoising_strength, resize_mode, save_individual_images=False, model_name=st.session_state["loaded_model"])
...
def print_file_exif(uploaded_images):
    if uploaded_images:
        exif_dict = piexif.load(uploaded_images)
        with open('C:/Users/Sigil/stable-diffusion-webui/file gens.txt', 'w') as f:
